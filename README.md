...
Alpine Linux [Docker Image](http://gliderlabs.viewdocs.io/docker-alpine/) (minimialist Docker OS image)  
...
[Diamanti](https://diamanti.com) (deploy Docker containers across clusters)  
